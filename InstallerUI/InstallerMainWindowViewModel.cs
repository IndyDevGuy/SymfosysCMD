...
namespace InstallerUI
{
	...
	public class InstallerMainWindowViewModel : BindableBase
	{
		...
		[Import]
		private IUIInteractiveService interactionService = null;
		...
		private bool StartMenuShortcutValue;

		public bool StartMenuShortcut
		{
			get { return this.StartMenuShortcutValue; }
			set 
			{ 
				this.SetProperty(ref this.StartMenuShortcutValue, value);
				string val = "true";
				if (!value)
					val = null;
				engine.StringVariables["StartMenuShortcut"] = val;
			}
		}

		private bool DesktopShortcutValue;

		public bool DesktopShortcut
		{
			get { return this.DesktopShortcutValue; }
			set 
			{ 
				this.SetProperty(ref this.DesktopShortcutValue, value);
				string val = "true";
				if (!value)
					val = null;
				engine.StringVariables["DesktopShortcut"] = val;
			}
		}

		private bool StartProgramValue;

		public bool StartProgram
		{
			get { return this.StartProgramValue; }
			set 
			{ 
				this.SetProperty(ref this.StartProgramValue, value);
				string val = "true";
				if (!value)
					val = null;
				engine.StringVariables["StartProgram"] = val;
			}
		}

		private bool InstalledValue;

		public bool Installed
		{
			get { return this.InstalledValue; }
			set 
			{
				this.SetProperty(ref this.InstalledValue, value);
			}
		}
